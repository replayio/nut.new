  ...
  useEffect(() => {
    ...
    const handleStripeCallback = async () => {
      if (stripeSuccess === 'topoff') {
        ...
        let details = 'Your monthly peanuts will be available shortly and will automatically renew each billing period.';
        ...
        if (tier && tier in SUBSCRIPTION_TIERS) {
          ...
          try {
            ...
            details = 'Please contact support and we\'ll resolve this quickly. Your subscription is valid and no additional payment is needed.';
          }
        }
