...
export function ChatDescription() {
  ...
  return (
    <div className="flex justify-start flex-1">
      {editing ? (
        <form onSubmit={handleSubmit} className="flex items-center justify-start w-full min-w-0 gap-3">
          <input
            type="text"
            className="bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary rounded-xl p-4 py-2 flex-1 min-w-0 truncate border border-bolt-elements-borderColor focus:border-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 shadow-sm hover:shadow-md"
            autoFocus
            value={currentTitle}
