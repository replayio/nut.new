...
async function handleSubscriptionChange(subscription: Stripe.Subscription) {
  try {
    ...
    if (priceId === 'price_1RtE7hEfKucJn4vkXKpmDNha') tier = 'starter';
    else if (priceId === 'price_1RtE9TEfKucJn4vkARIPfDb5') tier = 'builder';
    else if (priceId === 'price_1RtEBDEfKucJn4vkInF3CEvZ') tier = 'pro';
