    ...
    <>
      ...
      <form onSubmit={handlePasswordReset} className="space-y-6">
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 disabled:!bg-gradient-to-r disabled:!from-orange-400/60 disabled:!to-amber-400/60 text-white rounded-xl disabled:cursor-not-allowed font-semibold text-lg transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] disabled:hover:shadow-lg disabled:hover:scale-100 border border-white/20 hover:border-white/30 disabled:border-white/10 group"
        >
