  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        <p className="text-bolt-elements-textSecondary mt-2">Join us and start building. After signing
        up, you will receive <b>1000 free peanuts (credits)</b> to use for building your app.</p>
      </div>
