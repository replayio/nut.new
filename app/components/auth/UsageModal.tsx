      ...
      >
        <div className="flex-1">
          <div className="flex items-center gap-3">
            <div className="text-sm text-bolt-elements-textSecondary min-w-[120px]">
          ...
          <div className="mt-1 ml-[120px] text-sm text-bolt-elements-textSecondary">
