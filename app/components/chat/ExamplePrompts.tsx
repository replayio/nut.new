...
const EXAMPLE_PROMPTS = [
  ...
  { text: 'Build a team issue manager', full: 'build an app for helping my team manage issues for different projects. Users should be able to save their username in the settings and create new projects in a shared list. Users can also create issues for each project, and set their status ("todo", "in progress", "done"). Users should be able to add comments to each issue. Each issue and comment should show the user who created it. Store all data in a database.' },
];
