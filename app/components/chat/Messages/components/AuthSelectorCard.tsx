      ...
      <div className="space-y-3">
        ...
        {authRequired && (
          <div>
            <button
              type="button"
              className="px-3 py-2 text-sm rounded-md border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 hover:bg-bolt-elements-background-depth-3 transition-colors"
