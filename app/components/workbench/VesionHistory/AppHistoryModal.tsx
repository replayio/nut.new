...
const AppHistoryModal = () => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col w-full max-w-6xl max-h-[90vh] bg-card border border-border rounded-2xl shadow-2xl z-50"
        ...
        <div className="flex items-center justify-between p-6 border-b border-border/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">View and manage app versions</p>
            </div>
          </div>

          <IconButton
            onClick={closeAppHistoryModal}
            className="flex items-center justify-center w-8 h-8 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-all duration-200 hover:scale-105"
            icon={<X size={16} />}
