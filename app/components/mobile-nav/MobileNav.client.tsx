        ...
        <button
          ...
          className={classNames(
            'flex-1 flex flex-col items-center justify-center py-2 px-2 transition-colors',
            {
              ...
              'text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary hover:bg-bolt-elements-background-depth-1': activeTab !== 'chat',
            }
          )}
        >
        ...
        <button
          ...
          className={classNames(
            'flex-1 flex flex-col items-center justify-center py-2 px-2 transition-colors border-l border-r border-bolt-elements-borderColor',
            {
              ...
              'text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary hover:bg-bolt-elements-background-depth-1': activeTab !== 'planning',
            }
          )}
        >
        ...
        <button
          ...
          className={classNames(
            'flex-1 flex flex-col items-center justify-center py-2 px-2 transition-colors',
            {
              ...
              'text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary hover:bg-bolt-elements-background-depth-1': activeTab !== 'preview',
            }
          )}
        >
