...
const LandingPage = () => {
  ...
  return (
    <Tooltip.Provider>
        ...
        {!user && <div className="fixed top-2 left-3 z-[1000] cursor-pointer">
            <a href="/" className="block p-2 bg-bolt-elements-background-depth-2 rounded-lg border border-bolt-elements-borderColor hover:bg-bolt-elements-background-depth-3 transition-all duration-200 cursor-pointer">
