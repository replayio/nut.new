      ...
      <div className="space-y-4">
        {faqItems.map((item, index) => (
          ...
          >
            ...
            >
              <span className="text-bolt-elements-textHeading font-medium pr-4">
                {item.question}
              </span>
