  ...
  return (
    <div className="w-full max-w-4xl mx-auto mb-16">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-lg">Simple steps to get your app working</p>
      </div>
        ...
        {steps.map((step) => (
          <div key={step.number} className="text-center">
            <div className="flex justify-center mb-4">
              <div className="w-14 h-14 sm:w-20 sm:h-20 bg-white text-black rounded-full flex items-center justify-center text-3xl font-bold border-2 border-border shadow-lg">
                {step.number}
              </div>
            </div>
